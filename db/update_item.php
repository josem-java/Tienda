<?php
	...
	$stmt = $conn->prepare("UPDATE tbl_articulos SET bar_code = :bar_code, descripcion = :descripcion, cantidad_disponible = :cantidad_disponible, precio = :precio, precio_venta = :precio_venta WHERE id = :id");
